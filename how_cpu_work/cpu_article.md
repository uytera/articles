...
- [Как процессор выполняет инструкции](#как-процессор-выполняет-инструкции)
- [Как код превращается в инструкции процессора](#как-код-превращается-в-инструкции-процессора)
- [Архитектуры процессоров](#архитектуры-процессоров)
- [ILP](#instruction-level-parallelism)
- [DLP](#data-level-parallelism)
- [TLP](#thread-level-parallelism)
- [Кэш](#кэширование-инструкций-и-данных)
- [Мониторинг](#мониторинг-производительности-процессора)
